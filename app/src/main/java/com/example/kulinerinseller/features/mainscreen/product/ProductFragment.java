...
import com.example.kulinerinseller.features.mainscreen.statistic.TopProductAdapter;
...
public class ProductFragment extends Fragment {
    ...
    public ProductAdapter topProductAdapter;
    public View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return view = inflater.inflate(R.layout.fragment_product, container, false);
    }
...
//        hideStatusBar();
        ...
        this.initTopProduct();
        topProductRecyclerView = view.findViewById(R.id.recycler_view_product);
        topProductRecyclerView.setLayoutManager(new LinearLayoutManager(
                MainScreenActivity.getInstance()));
        topProductRecyclerView.setHasFixedSize(true);
        topProductAdapter = new ProductAdapter(products);
